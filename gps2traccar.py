...
import sys
sys.path.append('/volume1/homes/ba7ib/aprs-python-master/')
import aprslib
from socket import * 
import requests
...
config={
	...
	"relay_aprs_id":("AA1AA-5","BB2BB-7","cc3cc-6",),
	...
	"sms_gateway":"http://192.168.1.1:8001",
	"map_zoom":12,
	"geoapify_key":"AAAAAAAAAAAAAAAAAAAAAAAAAAAA",
}
